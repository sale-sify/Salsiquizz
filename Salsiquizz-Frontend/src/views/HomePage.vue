...
/* ========================    HOME PRESENTATION    ========================= */
/* Home presentation of the web site */
    .home-hero {
        width: 80%;
        height: 60%;
        display: flex;
...
/* ========================    CLICK TO ACTION    ========================= */
/* Click to action to create a new quizz and animation */
    .btn-start-quiz {
        min-width: 200px;
        min-height: 70px;
        padding: 0.8rem 2rem;
    ...
    .btn-start-quiz:hover {
        background-color: var(--bg-color-CTA-hover);
        border: 3px solid var(--border-color-CTA);
    }
    @keyframes bounce {
        0%, 100% {
